...
{
    public static class EncryptDecryptV2
    {
        private const int MAX_CHAR_CODE = 125;
        private const int MIN_CHAR_CODE = 32;
        private const int LIMIT_CHAR_CODE = MIN_CHAR_CODE - 1;
        /*
         * 
